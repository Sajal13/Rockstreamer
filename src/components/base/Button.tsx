...
const Button = ({
  ...
  const sizeClasses: Record<Size, string> = {
    ...
    large: 'px-5 py-3 text-sm rounded-lg'
  };
  ...
  const variantClasses: Record<Color | 'white', Record<Variant, string>> = {
    ...
    secondary: {
      ...
      text: 'border-0 bg-transparent text-secondary-500 hover:bg-secondary-500 hover:text-white'
    },
    success: {
      filled:
      ...
      text: 'border-0 bg-transparent text-success-500 hover:bg-success-500 hover:text-white'
    },
    warning: {
      filled:
      ...
      text: 'border-0 bg-transparent text-warning-500 hover:bg-warning-500 hover:text-white'
    },
    danger: {
      filled:
      ...
      text: 'border-0 bg-transparent text-danger-500 hover:bg-danger-500 hover:text-white'
    },
    info: {
      filled:
      ...
      text: 'border-0 bg-transparent text-info-500 hover:bg-info-400 hover:text-white'
    },
    white: {
      filled:
      ...
      text: 'border-0 bg-transparent text-white hover:text-white/80'
    }
  };
